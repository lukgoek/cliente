 ...
 * @author lugo
 */
public class InterfaceTwo extends javax.swing.JFrame {
    ...
    public void recibeDatos(){
        ...
        try {
            ...
            //System.out.println("RECIBE DATOS 2"+entradaDatos.readUTF());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceTwo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceTwo().setVisible(true);
            }
        });
    }
